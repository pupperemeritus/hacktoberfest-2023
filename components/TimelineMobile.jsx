  ...
  return (
    <div className=" flex justify-center">
      <div className=" flex flex-col items-center gap-10">
        <div className="sectionM mr-7 w-[60vmin] text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2 border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
          <h1 className=" md:text-2xl text-sm  tracking-tighter ">
            24th September
            <span className=" hidden md:inline">, 2023</span>
          </h1>
          <div className="flex flex-col items-start">
            <span className=" md:text-xl text-sm">Registrations Begin</span>
            <Link href="/register">
        ...
        <div className="sectionM mr-7 w-[60vmin]  text-bgold-200 md:h-60 h-30 md:px-8 mb-6 md:py-4 px-4 py-2 border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
        ...
        <div className="sectionM mr-7 w-[60vmin]  text-bgold-200 md:h-60 h-30  md:px-8 md:py-4 px-4 py-2 mb-6 border-2 border-bgold-200 rounded-xl flex flex-col justify-between  text-xl ">
          <div className=" tracking-tighter md:text-2xl text-sm">
            <h1>
              6th October
              <span className=" hidden md:inline">, 2023</span>
        ...
        <div className="sectionM w-[60vmin] mr-7 text-bgold-200 md:h-60 h-30 md:px-8 md:py-4 px-4 py-2 mb-6 border-2 border-bgold-200 rounded-xl flex flex-col justify-between text-xl ">
          <div className=" tracking-tighter md:text-2xl text-sm">
            <h1>
              8th October
              <span className=" hidden md:inline">, 2023</span>
        ...
        {/* Add more sectionMs as needed */}
      </div>
      <div className=" h-full border border-bgold-200 rounded-full w-2 bg-bblue-200"></div>
    </div>
  );
};
